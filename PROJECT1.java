...
class pro{
    ...
    public void menu(){
        ...
        System.out.println("click 5 to order DESSERTS");
        System.out.println("click 6 to order DRINKS");
        System.out.println("click 7 to order SIDES");
        System.out.println("click 8 to add an item");
        System.out.println("click 9 to order added items");
    ...
    public void soups(){
        ...
        System.out.print("Serial number"+"\t\t\t\t\t\t\t"+"Soups"+"\t\t\t\t\t\t\t\t"+"prices\n");
    ...
    public void Fastfoods() {
        ...
        System.out.print("Serial number" + "\t\t\t\t\t\t" + "Fast Foods" + "\t\t\t\t\t\t\t" + "prices\n");
    ...
    public void desserts(){
        ...
        System.out.print("Serial number"+"\t\t\t\t\t\t"+"Desserts"+"\t\t\t\t\t\t\t\t\t\t"+"  prices\n");
    ...
    public void drinks(){
        ...
        System.out.print("Serial number"+"\t\t\t\t\t\t"+"Drinks"+"\t\t\t\t\t\t\t\t\t"+"prices\n");
    ...
    public void sides(){
        ...
        System.out.print("Serial number"+"\t\t\t\t\t\t"+"Sides"+"\t\t\t\t\t\t\t"+"  Prices\n");
    ...
    public void bill(int result){
        ...
        if (result>500 && result<999){
            System.out.println("\nYour Bill Amount with discount is: "+(result-19));
        }
        else if (result>999 && result<1499){
            System.out.println("\nYour Bill Amount with discount is: "+(result-69));
        }
        else if (result>1500 && result<2000){
            System.out.println("\nYour Bill Amount with discount is: "+(result-99));
        }
        else if(result>2500){
            System.out.println("\nYour Bill Amount with discount is: "+(result-150));
        }
        else {
            System.out.println("Sorry you didn't get any discount");
            System.out.println("\nYour Bill Amount is: "+result);
        }
    ...
    public  void items(int [] item_price, String[] item_name,int numberOfItems) {
        System.out.print("Serial number"+"\t\t\t\t\t\t"+"Added items"+"\t\t\t\t\t\t"+"prices\n");
        for (int i = 0; i< numberOfItems; i++) {
